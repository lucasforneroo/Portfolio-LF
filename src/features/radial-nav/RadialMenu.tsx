...
export const RadialMenu: React.FC<RadialMenuProps> = ({ onNodeClick, isZooming, isUnzooming, activeNodeId }) => {
  ...
  return (
    <div className="relative flex items-center justify-center w-[900px] h-[900px] transition-all duration-1000 scale-[0.4] md:scale-100 origin-center" style={getZoomStyles()}>
